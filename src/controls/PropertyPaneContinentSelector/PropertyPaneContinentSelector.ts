...
import { IPropertyPaneContinentSelectorInternalProps } from "./IPropertyPaneContinentSelectorInternalProps";
...
export class PropertyPaneContinentSelector implements IPropertyPaneField<IPropertyPaneContinentSelectorProps> {
    ...
    private onChange(option: IDropdownOption, index?: number): void {
