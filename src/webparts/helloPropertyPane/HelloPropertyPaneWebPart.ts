...
export default class HelloPropertyPaneWebPart extends BaseClientSideWebPart<IHelloPropertyPaneWebPartProps> {
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                new PropertyPaneContinentSelector('myContinent', <IPropertyPaneContinentSelectorProps>{
                  label: 'Continent where I currentry reside',
                  disabled: false,
  ...
  private onContinentSelectionChange(propertyPath: string, newValue: unknown): void {
    update(this.properties, propertyPath, () => { return newValue });
    this.render();
  }
}
